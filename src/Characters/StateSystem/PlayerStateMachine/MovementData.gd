...
@export var friction : Vector2 = Vector2(0.25, 0.9) # pix/s
@export var time_scale : float = 1.0 # s

@export_group("Side movement", "side_")
@export var side_speed_max : float = 1.0 # pix/s
@export var side_instant_speed : float = 1.0 # pix/s
@export var side_instant_speed_return_thresh : float = 1.0 # pix/s
@export var side_accel : float = 1.0 # kg
